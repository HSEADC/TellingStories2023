...
;// CONCATENATED MODULE: ./src/live.js
...
var db = getDatabase();
var touchesCountRef = ref(db, 'touches');
...
onValue(touchesCountRef, function (snapshot) {
  var _window = window,
  ...
  var _data$lastKey = data[lastKey],
      uid = _data$lastKey.uid,
      emoji = _data$lastKey.emoji,
      x = _data$lastKey.x,
      y = _data$lastKey.y;
  var newX = innerWidth / 100 * 1 * x;
  var newY = innerHeight / 100 * 1 * y; // console.log(uid, x, y)
